...
namespace DYS.JPay.Shared.Shared.Services
{
    ...
    public interface ITransactionAPIService : IBaseService
    {
    ...
    public class TransactionAPIService : BaseService, ITransactionAPIService
    {
        private readonly IRequestProvider _requestProvider;
        private readonly NavigationManager _navigationManager;
        public TransactionAPIService(IRequestProvider requestProvider,
